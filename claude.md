...
## Active Technologies
- Node.js 18+ (LTS版本) (001-ai-news-collector)
- 本地文件系统(配置文件为JSON格式,输出为Markdown文件),无数据库依赖 (001-ai-news-collector)

## Recent Changes
- 001-ai-news-collector: Added Node.js 18+ (LTS版本)
...
## 代码坏味道识别与处理
基于Martin Fowler《重构》一书的核心观点，以下是应当注意的代码坏
味道及其处理方法：
...
- **示例**：将`fn create_user(name, email, phone, address, city, country)`改
为`fn create_user(user_info: UserInfo)`
